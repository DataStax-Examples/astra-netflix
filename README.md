...
✅ Register (if needed) and Sign In to Astra [https://astra.datastax.com](https://dtsx.io/3sYwYUL): You can use your `Github`, `Google` accounts or register with an `email`.
